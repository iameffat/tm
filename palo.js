(function() {
    ...
    function downloadImages() {
        ...
        var htmlContent = "<html><head><title>Prothom Alo Image Slider</title><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1, user-scalable=yes'><style>body {background: #2e2e2e;}.slider {max-width: 100%; position: relative;}.slides {display: none; text-align: center;}.slides img {max-width: 100%; height: auto;}.prev, .next {cursor: pointer; position: absolute; top: 1%; transform: translateY(-50%); padding: 16px; color: white; background: #4e4e4e5c; font-weight: bold; font-size: 20px; transition: 0.6s ease; border-radius: 0 3px 3px 0; display: block;}.next {right: 0; border-radius: 3px 0 0 3px;}.prev:hover, .next:hover {background-color: rgba(0, 0, 0, 0.8);}.caption {text-align: center; color: #fff; position: absolute; bottom: 8px; width: 100%;}</style></head><body><div class='slider'>";
